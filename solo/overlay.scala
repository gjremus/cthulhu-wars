...
object Overlays {
    ...
    def info(s : $[Any]) : |[String] = (s @@ {
        ...
        // ── NEW TERRORS ──
        case $("Dhole") => loyaltyCard("Dhole", 1, 4, 5, "Pay 2 Doom + 2 Power. Place at your Controlled Gate.", "Planetary Destruction", "Post-Battle", "If the Dhole is Killed or Eliminated in a Battle, earn 2 Elder Signs. Additionally, your opponent gains your choice of 2 Doom or 2 Power.")
        case $("Great Race of Yith") => loyaltyCard("Great Race of Yith", 1, 4, 3, "Pay 2 Doom + 2 Power. Place at your Controlled Gate.", "Possession", "Ongoing and Gather Power Phase", "If the Great Race of Yith is in an Area with an enemy Cultist, you may Capture that Cultist regardless of the presence of any enemy Units or Great Old Ones (or whether Windwalker's Ferox ability is in effect). In addition, if the Great Race of Yith is in play during the Gather Power Phase, earn 1 Power per Captured Cultist in addition to the normal reward of 1 Power per Cultist.")
        case $("Quachil Uttaus") => loyaltyCard("Quachil Uttaus", 1, 4, 1, "Pay 2 Doom + 2 Power. Place at your Controlled Gate.", "Dust to Dust", "Post-Battle", "If an enemy Unit is Killed or Eliminated in a Battle involving Quachil Uttaus, that Unit's owner must choose one of the following options: 1) Select one of his lost Units to be permanently removed from the game, OR 2) You receive an Elder Sign.")
        case $("The Shadow Pharaoh") => loyaltyCard("The Shadow Pharaoh", 1, 2, 0, "Pay 2 Doom + 2 Power (CC: 0 Doom, others gain 1 ES). Place at your Controlled Gate.", "Hebephrenia", "Ongoing", "Gates may not be Controlled by any Faction in the Shadow Pharaoh's Area. When the Shadow Pharaoh enters an Area, any occupying Unit immediately Abandons the Gate. (Yog-Sothoth is unaffected.)")
        case $("Hound of Tindalos") => loyaltyCard("Hound of Tindalos", 1, 4, 4, "Pay 2 Doom + 2 Power (Terror). Place at ANY Gate on the map.", "Cronophage", "Ongoing", "After the Hound moves, it may immediately teleport to any Gate on the map.<br><br><b>Angles of Time</b> (Ongoing): The Hound cannot be assigned a Kill result. If the Hound is in an Area without a Gate at the end of any Action Phase turn, it is eliminated.")
        case $("Brown Jenkin") => loyaltyCard("Brown Jenkin", 1, 2, 0, "Pay 2 Doom + 2 Power. Place at your Controlled Gate.", "Loathsome Titter + Familiar", "Gather Power Phase + Ongoing", "Loathsome Titter: If Brown Jenkin shares an Area with an enemy-Controlled Gate during the Gather Power Phase, gain 2 Power, plus 1 more Power for each enemy Cultist in the Area.<br><br>Familiar: If Brown Jenkin is Killed or Eliminated, if (or as soon as) you have at least 2 Power, pay 2 Power and place Brown Jenkin at your Controlled Gate. This does not count as an Action. This is not optional.")
        case $("Elder Shoggoth") => loyaltyCard("Elder Shoggoth", 1, 4, 2, "Pay 2 Doom + 2 Power. Place at your Controlled Gate.", "Prime Cause", "Post-Battle", "In a Battle involving the Elder Shoggoth, choose any of your Units (including this one) and replace it with any other Unit from your Pool. You can gain a Faction Great Old One that was previously Awakened, but still must fulfill other requirements (for example, to place Cthulhu, the Battle must be in his Start Area, plus a gate). If you choose to replace the Elder Shoggoth itself, pay nothing, and no enemy gains a reward. Otherwise, follow these rules: Pay half the new Unit's Power cost (rounded down-so you pay 1 Power for a cost 3 Monster). If the new Unit is a Terror, the enemy gains 1 Doom. If the new Unit is a Great Old One, the enemy gains 1 Elder Sign.")

        // ── NEW MONSTERS ──
        case $("Moonbeast") => loyaltyCard("Moonbeast", 4, 2, 0, "Pay 2 Doom. Place onto enemy Spellbook.", "Blasphemous Obeisance", "Ongoing", "When a Moonbeast is Summoned, place it on a Spellbook on an enemy's Faction Card. While the Moonbeast is on that Spellbook, that Spellbook cannot be used (it still counts for other purposes such as Unlimited Battle, and winning the game). In the next Doom Phase, remove all Moonbeasts from enemy Spellbooks and place them into any Areas on the Map containing a Controlled Gate(s). A Moonbeast may be prematurely returned to the Map if its victim spends 1 Doom point (at any time; this does not count as an Action).<br/><br/>Blocking the following Spellbooks will have the following exceptions to the block effects:<br/>Submerge: Still allows Unsubmerge.<br/>Cursed Slumber: Allows return to map.<br/>Red Sign: Does not force Dark Young to abandon gates they control.<br/>Ancient Sorcery: Does not immediately return Serpent Men to map. If Sleeper is already hibernated, does not activate Sleeper or deduct hibernation power bonus.<br/>Ice Age: Marker remains, power penalty is blocked.")
        case $("Giant Blind Albino Penguins") => loyaltyCard("Giant Blind Albino Penguins", 2, 1, -2, "Pay 2 Doom. Place at Controlled Gate.", "Laughingstock", "Pre-Battle", "Move one or more Penguins to the Battle area, even if you are not part of the battle. If you are part of the Battle, the penguin fights on your side. Otherwise, you choose which side the Penguin is on, and it belongs to that player until the battle's end.")
        ...
        case $("Leng Spider") => loyaltyCard("Leng Spider", 3, 2, 1, "Pay 2 Doom. Place at Controlled Gate.", "Bloodthirst", "Ongoing", "If a Leng Spider is involved in a Battle, you may exchange two Pain results for a Kill before results are assigned. You may do this once for each Leng Spider in the Battle. Each use of this ability may be applied to your results OR your opponent's.")
        case $("Satyr") => loyaltyCard("Satyr", 3, 2, 1, "Pay 2 Doom. Place 1 Satyr + 1 Acolyte.", "Fecund", "Ongoing", "Each time you Summon a Satyr, also place an Acolyte Cultist from your Pool into the same Area.")
        case $("Servitor of the Outer Gods") => loyaltyCard("Servitor of the Outer Gods", 3, 2, -1, "Pay 2 Doom. Choose an enemy faction to receive this card and its units. Summon cost: 1 Power each.", "Summon Block", "Ongoing", "While Servitors remain in your Pool, you may not Summon other Monsters (Terrors are unaffected). Combat: -1 per Servitor in Battle.")
        case $("Insects from Shaggai") => loyaltyCard("Insects from Shaggai", 3, 2, 0, "Pay 2 Doom. Place in any Area.", "Mind Parasite", "Ongoing", "All Acolytes Cultists <u>who are not on a Gate</u>, and who share an Area with an Insect from Shaggai, are Controlled by you during the Action Phase for the following purposes only:<br><span class=cost-color>1:</span> Only you can Move them. <span class=cost-color>2:</span> They fight on your side in any Battle.<br>They do not benefit from any Faction's Spellbooks (including yours). They can only be Captured by you if their true Faction permits it. They cannot be Captured by their true Faction (though they could be targeted by a Spellbook or Killed in Battle by them, etc.). Once an Acolyte is no longer in an Insect's Area, he is free. These Cultists are not Controlled by you during the Gather Power or Doom Phases\u2014they provide Power and Doom to their true Faction.")

        // ── iGOO overlays — no-param (setup menu ? click) ──
        case $("Byatis") => loyaltyCardIGOO(ByatisCard.name, "" + ByatisCard.cost, "" + ByatisCard.combat, false, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 4 Power, and place Byatis in the Area containing the Gate.", "Toad of Berkeley", "Ongoing", "Byatis may not Move, nor can he be moved. If there are no enemy Units in Byatis' Area during the Doom Phase, earn 1 Elder Sign.", "Byatis survives a Battle in which at least one enemy Unit is Killed", "God of Forgetfulness", "Action: Cost 1", "Select all enemy Cultists in an Area adjacent to Byatis. Those Cultists are moved into Byatis' Area.")
        case $("Abhoth") => loyaltyCardIGOO(AbhothCard.name, "" + AbhothCard.cost, "Equals Filth Tokens in play", false, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 4 Power, and place Abhoth in the Area containing the Gate.", "Filth", "Action: Cost 1", "Place a Filth Token in any Area.", "4+ different Monster types in play OR 8+ total Monsters in play", "The Brood", "Ongoing", "Gates in Areas containing Filth Tokens do not count during the Doom phase.")
        case $("Daoloth") => loyaltyCardIGOO("Daoloth", "4", "0", false, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 4 Power, and place Daoloth in the Area containing the Gate.", "Cosmic Unity", "Pre-Battle", "Before a Battle involving Daoloth, if an enemy GOO is present, Daoloth gains that GOO's combat value.", "Kill an enemy GOO in Battle.", "Interdimensional", "Ongoing", "When Daoloth moves to an Area without a Gate, place a Gate there.")
        case $("Nyogtha") => loyaltyCardIGOO("Nyogtha", "4", "4 attacking / 1 defending", false, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 4 Power, and place Nyogtha in the Area containing the Gate.", "From Below", "Ongoing", "After a Capture action, if Nyogtha is in a different Area, perform a second Capture from Nyogtha's Area.", "Have 2 Nyogthas in play.", "Nightmare Web", "Action: Cost 2", "Awaken a second Nyogtha at any Gate you control.")
        case $("Tulzscha") => loyaltyCardIGOO("Tulzscha", "4", "1", false, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 4 Power, and place Tulzscha in the Area containing the Gate.", "Undying Flame", "Gather Power", "If any enemy has more Doom, ES, or Power, gain +1 of each category where behind.", "Give each enemy 2 Power.", "Ceremony of Annihilation", "Doom Phase", "Take current ritual cost as Power instead of performing normal ritual.")
        case $("Y'Golonac") => loyaltyCardIGOO("Y'Golonac", "2", "1", false, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 2 Power, and place Y'Golonac in the Area containing the Gate.", "Orifices", "Post-Battle", "When Y'Golonac is killed, choose an enemy unit to eliminate; Y'Golonac transfers to that faction.", "All factions have at least 1 GOO in play.", "The Revelations", "Doom Phase", "Every enemy faction gains 1 Elder Sign during Doom Phase.")
        ...
        case $("Ghatanothoa") => loyaltyCardIGOO("Ghatanothoa (IGOO)", "4", "Enemy Cultists on map", false, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 4 Power, and place Ghatanothoa in the Area containing the Gate.", "Mummify", "Action: Cost 1", "Enemy Cultists sharing Area with Ghatanothoa are Mummified.", "Control 2 or fewer Gates, or pay 3 Power.", "Execration of Mu", "Ongoing", "Mummify is now instant/ongoing.")
        ...
        case $("Atlach-Nacha") => loyaltyCardIGOO("Atlach-Nacha", "4", "0", false, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 4 Power, and place Atlach-Nacha in the Area containing the Gate.", "Place Spinneret", "Action: Cost 1", "Place a web token in Atlach-Nacha's region.", "6 web tokens on the map in different areas.", "Cosmic Web", "Ongoing", "Immediate victory.")
        case $("Bokrug") => loyaltyCardIGOO("Bokrug", "6", "0", false, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 6 Power, and place Bokrug in the Area containing the Gate.", "Ghosts of Ib", "Doom Phase", "If Bokrug is not on the map, place Bokrug in any area without enemy units.", "Give Bokrug to another player.", "Doom that Came to Sarnath", "Doom Phase", "An enemy chooses a unit to eliminate or an Elder Sign to discard.")
        ...
        case $("Atlach-Nacha", _ : Boolean) => loyaltyCardIGOO("Atlach-Nacha", "4", "0", false, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 4 Power, and place Atlach-Nacha in the Area containing the Gate.", "Place Spinneret", "Action: Cost 1", "Place a Web Token in Atlach-Nacha's Area. A Web Token cannot be placed in an Area that already has a Web Token or a Desecration Token.", "Place 6 Web Tokens in 6 different Areas.", "Cosmic Web", "Immediate", "Your Faction wins the game immediately.")
        case $("Atlach-Nacha", spellbook : Boolean, facedown : Boolean) => loyaltyCardIGOO("Atlach-Nacha", "4", "0", spellbook, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 4 Power, and place Atlach-Nacha in the Area containing the Gate.", "Place Spinneret", "Action: Cost 1", "Place a Web Token in Atlach-Nacha's Area. A Web Token cannot be placed in an Area that already has a Web Token or a Desecration Token.", "Place 6 Web Tokens in 6 different Areas.", "Cosmic Web", "Immediate", "Your Faction wins the game immediately.", facedown)
