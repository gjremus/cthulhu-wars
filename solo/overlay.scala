...
object Overlays {
    ...
    def info(s : $[Any]) : |[String] = (s @@ {
        ...
        case $("Atlach-Nacha") => loyaltyCardIGOO("Atlach-Nacha", "6", "4", false, "1. Your Controlled Gate is in an Area with your Great Old One.<br>2. Pay 6 Power, and place Atlach-Nacha in the Area containing the Gate.", "Place Spinneret", "Action: Cost 1", "Place a web token in Atlach-Nacha's region.", "6 web tokens on the map in different areas.", "Cosmic Web", "Ongoing", "Immediate victory.")
