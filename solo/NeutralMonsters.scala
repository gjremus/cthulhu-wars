...
object NeutralMonstersExpansion extends Expansion {
    ...
    override def triggers()(implicit game : Game) {
        ...
        // 2026-07-21: replaced the old "force-abandon + map-wide reclaim" logic (ported from TT/HB).
        // The old reclaim block re-granted the SP-card owner gate control anywhere on the map on EVERY
